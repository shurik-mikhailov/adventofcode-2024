"""
Что ж, за эту задачу я тоже почти ничего не получил. Однако мне понравилось, что я смог
без какой-либо помощи понять, что для решения этой задачи достаточно всего двух условий.
Перебрать список, в принципе, не было сложной задачей.
"""
