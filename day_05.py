"""
К сожалению, моих знаний хватило только на четыре дня.
Очень долго ломал голову, в итоге пришлось обратиться к одному из решений,
где использовалась кастомная сортировка. Никогда не знал про это.
Думаю, переписывать своими словами чужие решения – не самое злостное деяние,
главное, что я узнал для себя что-то новое.
"""
